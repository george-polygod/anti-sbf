...
contract LGEWhitelisted is Context {
    ...
    modifier onlyWhitelister() {
        require(_whitelister == _msgSender() || address(this) == _msgSender() || _owner == _msgSender(), "Caller is not the whitelister");
        _;
    }
    ...
    function addPair(address pairAddress) external onlyWhitelister() 
    {
